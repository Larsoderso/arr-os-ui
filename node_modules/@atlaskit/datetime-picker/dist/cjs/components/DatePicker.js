...
var DatePicker = /** @class */ (function (_super) {
    ...
    DatePicker.prototype.render = function () {
        var _a = this.props, appearance = _a.appearance, autoFocus = _a.autoFocus, disabled = _a.disabled, hideIcon = _a.hideIcon, icon = _a.icon, id = _a.id, innerProps = _a.innerProps, isDisabled = _a.isDisabled, isInvalid = _a.isInvalid, name = _a.name, selectProps = _a.selectProps, spacing = _a.spacing, locale = _a.locale, testId = _a.testId;
        var BORDER_WIDTH = 2;
        var ICON_PADDING = 2;
        ...
        return (react_1.default.createElement("div", tslib_1.__assign({}, innerProps, { role: "presentation", onClick: this.onInputClick, onInput: this.onSelectInput, onKeyDown: this.onSelectKeyDown, ref: this.getContainerRef, "data-testid": testId && testId + "--container" }),
            ...
            react_1.default.createElement(select_1.default, tslib_1.__assign({ menuIsOpen: isOpen && !isDisabled, openMenuOnFocus: true, closeMenuOnSelect: true, autoFocus: autoFocus, instanceId: id, isDisabled: isDisabled, onBlur: this.onSelectBlur, onFocus: this.onSelectFocus, inputValue: inputValue, onInputChange: this.handleInputChange, components: {
                    ...
                    value: value,
                } }, selectProps, calendarProps, { spacing: spacing, validationState: isInvalid ? 'error' : 'default', testId: testId }))));
    };
