    ...
    DateTimePicker.prototype.render = function () {
        ...
        return (react_1.default.createElement(Flex, tslib_1.__assign({}, innerProps, { isFocused: isFocused, isDisabled: isDisabled, isInvalid: this.props.isInvalid, appearance: this.props.appearance }),
            ...
            react_1.default.createElement(FlexItem, null,
                react_1.default.createElement(DatePicker_1.default, tslib_1.__assign({}, bothProps, { autoFocus: autoFocus, dateFormat: dateFormat, icon: null, id: id, onChange: this.onDateChange, selectProps: mergedDatePickerSelectProps, value: dateValue, locale: locale, testId: testId && testId + "--datepicker" }, datePickerProps))),
            react_1.default.createElement(FlexItem, null,
                react_1.default.createElement(TimePicker_1.default, tslib_1.__assign({}, bothProps, { icon: icon, onChange: this.onTimeChange, selectProps: mergedTimePickerSelectProps, value: timeValue, timeIsEditable: timeIsEditable, times: times, timeFormat: timeFormat, locale: locale, testId: testId && testId + "--timepicker" }, timePickerProps)))));
    };
