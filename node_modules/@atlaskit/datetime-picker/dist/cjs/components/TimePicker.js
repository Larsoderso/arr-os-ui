...
var TimePicker = /** @class */ (function (_super) {
    ...
    TimePicker.prototype.render = function () {
        var _this = this;
        var _a = this.props, autoFocus = _a.autoFocus, id = _a.id, innerProps = _a.innerProps, isDisabled = _a.isDisabled, name = _a.name, selectProps = _a.selectProps, spacing = _a.spacing, testId = _a.testId;
        var ICON_PADDING = 2;
        var BORDER_WIDTH = 2;
        ...
        return (react_1.default.createElement("div", tslib_1.__assign({}, innerProps, { ref: this.setContainerRef, "data-testid": testId && testId + "--container" }),
            ...
            react_1.default.createElement(SelectComponent, tslib_1.__assign({ autoFocus: autoFocus, components: {
                ...
                }), value: labelAndValue, spacing: spacing, dropdownIndicatorIcon: icon, fixedLayerRef: this.containerRef, validationState: validationState, testId: testId }, otherSelectProps))));
    };
