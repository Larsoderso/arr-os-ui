    ...
    DateTimePicker.prototype.render = function () {
        ...
        return (React.createElement(Flex, __assign({}, innerProps, { isFocused: isFocused, isDisabled: isDisabled, isInvalid: this.props.isInvalid, appearance: this.props.appearance }),
            ...
            React.createElement(FlexItem, null,
                React.createElement(DatePicker, __assign({}, bothProps, { autoFocus: autoFocus, dateFormat: dateFormat, icon: null, id: id, onChange: this.onDateChange, selectProps: mergedDatePickerSelectProps, value: dateValue, locale: locale, testId: testId && testId + "--datepicker" }, datePickerProps))),
            React.createElement(FlexItem, null,
                React.createElement(TimePicker, __assign({}, bothProps, { icon: icon, onChange: this.onTimeChange, selectProps: mergedTimePickerSelectProps, value: timeValue, timeIsEditable: timeIsEditable, times: times, timeFormat: timeFormat, locale: locale, testId: testId && testId + "--timepicker" }, timePickerProps)))));
    };
