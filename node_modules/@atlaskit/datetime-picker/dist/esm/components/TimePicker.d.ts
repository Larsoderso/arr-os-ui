...
declare class TimePicker extends React.Component<Props, State> {
    ...
    getSubtleControlStyles: (selectStyles: Partial<import("react-select").Styles>) => {
        border: string;
