...
export declare type DefaultsType = {
    ...
    IconWrapper: {
        ...
        attributesFn: (props: Partial<StripOverrides<IconWrapperProps>>) => Record<string, any>;
    };
    Icon: {
...
export declare type OverridesType = {
    ...
    LabelText?: {
        component?: React.ComponentType<LabelTextProps>;
        cssFn?: (defaultStyles: CSSObject, state: {
            tokens: ThemeTokens;
        }) => CSSObject;
        attributesFn?: () => Record<string, any>;
    };
...
export declare type CheckboxDefaults = Pick<DefaultsType, 'Label' | 'LabelText' | 'HiddenCheckbox'>;
export declare type CheckboxOverrides = Pick<OverridesType, 'Label' | 'LabelText' | 'HiddenCheckbox'>;
export declare type CheckboxIconDefaults = Pick<DefaultsType, 'Icon' | 'IconWrapper' | 'IconIndeterminate'>;
export declare type CheckboxIconOverrides = Pick<OverridesType, 'Icon' | 'IconWrapper' | 'IconIndeterminate'>;
/**
 *
 *
 ...
 *
 */
export declare type ThemeFn = (current: PrevThemeFn, props: ThemeProps) => ThemeTokens;
export declare type PrevThemeFn = (props: ThemeProps) => ThemeTokens;
interface ModeValue {
    light: string;
    dark: string;
}
declare type TokenValue = ModeValue | string;
...
declare type StripOverrides<P extends Record<string, any>> = Pick<P, Exclude<keyof P, 'cssfn' | 'attributesFn'>>;
...
export interface IconWrapperProps extends React.HTMLProps<HTMLLabelElement> {
    attributesFn: (props: Partial<StripOverrides<IconWrapperProps>>) => Record<string, any>;
    cssFn: (props: Pick<IconWrapperProps, Exclude<keyof IconWrapperCSSProps, 'cssFn'>>) => CSSObject;
    tokens: ThemeTokens;
    isChecked?: boolean;
    isDisabled?: boolean;
    isActive?: boolean;
...
export declare type IconWrapperCSSProps = Omit<IconWrapperProps, 'attributesFn' | 'cssFn'>;
export declare type LabelCSSProps = Pick<LabelProps, 'isDisabled' | 'tokens'>;
