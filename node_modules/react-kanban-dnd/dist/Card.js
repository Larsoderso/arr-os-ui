...
var Card = function (_a) {
    var isDragging = _a.isDragging, provided = _a.provided, dragSnapshot = _a.dragSnapshot, renderCard = _a.renderCard, row = _a.row, cardWrapperStyle = _a.cardWrapperStyle;
    return (React.createElement(Container, __assign({ innerRef: provided.innerRef }, provided.draggableProps, provided.dragHandleProps, { isDragging: dragSnapshot.isDragging }),
