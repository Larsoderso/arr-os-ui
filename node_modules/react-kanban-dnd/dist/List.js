...
var DropZone = styled_components_1.default('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n\n"], ["\n\n"])));
var List = function (_a) {
    ...
    return (React.createElement(react_beautiful_dnd_1.Droppable, { droppableId: listId || 'LIST', isDropDisabled: isDropDisabled, type: "ROW" }, function (dropProvided, dropSnapshot) { return (React.createElement(Wrapper, __assign({ style: columnStyle, innerRef: dropProvided.innerRef, isDraggingOver: dropSnapshot.isDraggingOver, isDropDisabled: isDropDisabled }, dropProvided.droppableProps),
