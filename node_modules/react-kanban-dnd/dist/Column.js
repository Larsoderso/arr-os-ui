...
var Title = styled_components_1.default('h4')(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  padding: 10px;\n  transition: background-color ease 0.2s;\n  flex-grow: 1;\n  user-select: none;\n  position: relative;\n  &:focus {\n    outline: 2px solid purple;\n    outline-offset: 2px;\n  }\n  font-size: 14px;\n  font-weight: 600;\n  font-family: 'Open Sans', sans-serif;\n  color: #515c6a;\n"], ["\n  padding: 10px;\n  transition: background-color ease 0.2s;\n  flex-grow: 1;\n  user-select: none;\n  position: relative;\n  &:focus {\n    outline: 2px solid purple;\n    outline-offset: 2px;\n  }\n  font-size: 14px;\n  font-weight: 600;\n  font-family: 'Open Sans', sans-serif;\n  color: #515c6a;\n"])));
...
var Column = /** @class */ (function (_super) {
    ...
    Column.prototype.render = function () {
        ...
        return (React.createElement(react_beautiful_dnd_1.Draggable, { draggableId: column.id, index: index, isDragDisabled: false }, function (provided) { return (React.createElement(Wrapper, __assign({ innerRef: provided.innerRef }, provided.draggableProps),
            React.createElement(Container, { style: columnWrapperStyle },
                React.createElement(Header, __assign({}, provided.dragHandleProps, { style: columnHeaderStyle }),
                    React.createElement(Title, __assign({ style: columnTitleStyle }, provided.dragHandleProps), column.title)),
